...
class Kurv {
    ...
    grebet = function(xa, ya, ra) {
        if ((ya < this.y+2 && ya > this.y-2) && xa > this.x+ra && xa < this.x+this.bred-ra) { // ændret til at være +1 og -1 så frugter ikke klipper igennem så tit. Selvom det bliver lidt nemmere.
            return true;
        }
        else {
            return false;
